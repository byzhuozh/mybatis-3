...
public class MapperMethod {
    ...
    private Object rowCountResult(int rowCount) {
        ...
        if (method.returnsVoid()) { // Void 情况，不用返回
            result = null;
        } else if (Integer.class.equals(method.getReturnType()) || Integer.TYPE.equals(method.getReturnType())) { // Integer
            result = rowCount;
    ...
    public static class SqlCommand {
        ...
        public SqlCommand(Configuration configuration, Class<?> mapperInterface, Method method) {
            ...
            if (ms == null) {
                ...
                // 获得 name
                name = ms.getId();  // 实际上，就是 ${NAMESPACE_NAME}.${语句_ID}
                // 获得 type
        ...
        /**
         * 每一个 XML 里声明的例如 <select /> 或者 <update /> 等等，都对应一个 MappedStatement 对象
         *
        ...
        private MappedStatement resolveMappedStatement(Class<?> mapperInterface, String methodName,
            ...
            for (Class<?> superInterface : mapperInterface.getInterfaces()) {
                if (declaringClass.isAssignableFrom(superInterface)) { //declaringClass 是 superInterface 父类
                    // 递归处理
