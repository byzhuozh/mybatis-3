...
public class SelectKeyGenerator implements KeyGenerator {
        ...
        try {
            ...
            if (parameter != null && keyStatement != null && keyStatement.getKeyProperties() != null) {
                ...
                if (keyProperties != null) {
                    ...
                    // <3> 执行查询主键的操作【按照 SelectKeyGenerator 的思路，岂不是可以可以接入 SnowFlake 算法，从而实现分布式主键】
    ...
    /**
     * 多个主键，调用 #handleMultipleProperties(String[] keyProperties, MetaObject metaParam, MetaObject metaResult) 方法，遍历，进行赋值
     *
     * @param keyProperties
     * @param metaParam
     * @param metaResult
