...
public class XMLMapperBuilder extends BaseBuilder {
    ...
    /**
     * 重新处理 {@link XMLMapperBuilder#parse()} 中未处理成功的 <resultmap> </resultmap> 节点
     */
    ...
    /**
     * 解析 <cache-ref /> 节点
     * eg:   <cache-ref namespace="org.apache.ibatis.domain.blog.mappers.BlogMapper"/>
     *
     * @param context
     */
     ...
     * 解析 <resultMap /> 节点们
     * <p>
     * eg: \mybatis-3\src\test\java\org\apache\ibatis\builder\BlogMapper.xml
     *
     * @param list
     * @throws Exception
     */
    ...
    /**
     * 处理 <constructor /> 节点
     * eg： mybatis-3\src\test\java\org\apache\ibatis\binding\BoundBlogMapper.xml
     *
     * @param resultChild
     * @param resultType
    ...
    /**
     * 处理 <discriminator></discriminator> 节点
     * eg: mybatis-3\src\test\java\org\apache\ibatis\builder\BlogMapper.xml
     *
     * @param context
     * @param resultType
    ...
    private Discriminator processDiscriminatorElement(XNode context, Class<?> resultType, List<ResultMapping> resultMappings) throws Exception {
        ...
        for (XNode caseChild : context.getChildren()) {
            ...
            // 如果是内嵌的 ResultMap 的情况，则调用 #processNestedResultMappings(XNode context, List<ResultMapping> resultMappings) 方法，
            // 处理内嵌的 ResultMap 的情况
    ...
    /**
     * 解析 <sql /> 节点们
     *  eg: mybatis-3\src\test\java\org\apache\ibatis\submitted\enumtypehandler_on_map\Person.xml
     *
     * @param list
